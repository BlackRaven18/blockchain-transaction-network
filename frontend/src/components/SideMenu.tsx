...
export default function SideMenu() {
    ...
    const { showEdges, resetServerEdgesAnimations } = useBlockchain()
    ...
    return (
        <Stack direction={"column"} spacing={5} sx={styles.container}>
            ...
            <Button variant="contained" disabled={!isNodesConnected} onClick={async () => resetServerEdgesAnimations()}>Reset Edges Animations (optional)</Button>
        </Stack>
    )
}
